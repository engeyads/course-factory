...
// $images = getImagesInFolder($ftpServer,$connection,$_GET['c'],$_GET['t'],$_GET['remoteDirectory'],$_GET['dir'],$_GET['col'],$conn2,$lnk);
$images = getImagesInFolderpst($ftpServer,$connection,$_GET['col'],$_GET['c'],$_GET['t'],$_GET['url'],$conn2);
