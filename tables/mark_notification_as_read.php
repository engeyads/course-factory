...
if (isset($_POST['notification_id'])) {
    ...
    $updateSql = "UPDATE notifications SET status = 'read' WHERE notification_id = $notificationId";
    $result = mysqli_query($conn, $updateSql);

    if ($result) {
        echo json_encode(['success' => true, 'message' => 'Notification marked as read successfully']);
    } else {
