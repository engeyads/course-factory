...
switch ($db_name) {
        case "agile4training":
            $ignoredColumns = ['p','p1','country_image','s_alias', 'color', 'another_column', 'deleted_at','publish'];
            $tooltips = ['', 'title' ];
        ...
        case "blackbird-training.co.uk":
            ...
            break;
        case "mercury_dubai":
            $ignoredColumns = ['p','p1','map','country_image','alias', 'color', 'another_column', 'deleted_at','publish'];
        ...
        case "blackbird-training":
            $ignoredColumns = ['p','p1','country_image','alias', 'color', 'another_column', 'deleted_at','publish','Things_to_do_and_places_to_visit', 'hotel_address', 'embed_map', 'hotel_logo'];
            $tooltips = ['', 'title' ];
            $popups = ['description', 'keyword', 'text','about'];
            $jsonarrays = ['keyword', 'xx'];
            $urlPaths = [];
            ...
            break;
            case "Euro Wings En":
                $ignoredColumns = ['p','p1','country_image','alias', 'color', 'another_column', 'deleted_at','publish'];
            $tooltips = ['', 'title' ];
            $popups = ['description', 'keyword', 'text','about'];
            $jsonarrays = ['keyword', 'xx'];
            $urlPaths = [];
