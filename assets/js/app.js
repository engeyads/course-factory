...
$(function() {
  ...
  // Tooltops
	...
	$(function() {
		for (var e = window.location, o = $(".metismenu2 li a").filter(function() {
				return this.href == e
			}).addClass("").parent().addClass("mm-active"); o.is("li");) o = o.parent("").addClass("mm-show").parent("").addClass("mm-active")
	})
    ...
    function changeThemeAndStore(theme) {
	...
	if (savedTheme) {
		changeThemeAndStore(savedTheme);
		$(`input[name=themeOptions][value="${savedTheme}"]`).prop('checked', true);
	}
